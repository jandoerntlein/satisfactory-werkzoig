...
*/
    ...
    LGraphNode.prototype.serialize = function() {
        ...
        this.serialize_widgets = true // HOTFIX :)
...
*/
    ...
    function LGraphCanvas(canvas, graph, options) {
        ...
        this.title_text_font = "" + LiteGraph.NODE_TEXT_SIZE + "px Roboto Condensed";
        this.inner_text_font =
            "normal " + LiteGraph.NODE_SUBTEXT_SIZE + "px Roboto Condensed";
	...
	*/
    ...
    LGraphCanvas.prototype.processNodeDblClicked = function(n) {
		...
		{
            console.log("this.showShowNodePanel(n) prevented")
	...
	*/
	...
	LGraphCanvas.prototype.drawButton = function( x,y,w,h, text, bgcolor, hovercolor, textcolor )
	{
		...
		if(text != null)
		{
			if(text.constructor == String)
			{
				...
				ctx.font = ((h * 0.65)|0) + "px Roboto Condensed";
    ...
    LGraphCanvas.prototype.drawGroups = function(canvas, ctx) {
        ...
        for (var i = 0; i < groups.length; ++i) {
            ...
            ctx.font = font_size + "px Roboto Condensed";
			ctx.textAlign = "left";
